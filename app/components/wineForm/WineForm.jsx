...
export default function WineForm() {
  ...
  return (
    <div>
      <button
        className={style.wineForm_add_btn}
      ...
      {showModal && (
        ...
        >
          ...
          <div className={style.wineForm_form_btn}>
            <button className={style.wineForm_form_btn_cancel} type="reset">
              Cancela
            </button>
            <button className={style.wineForm_form_btn_add} type="submit">
              Adicionar
            </button>
          </div>
        </form>
